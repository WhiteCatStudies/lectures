...
QT_MOC_LITERAL(1, 10, 16), // "_onButtonClicked"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "HelloForm\0_onButtonClicked\0"
};
...
void HelloForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HelloForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->_onButtonClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject HelloForm::staticMetaObject = { {
    ...
    qt_meta_stringdata_HelloForm.data,
    qt_meta_data_HelloForm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
